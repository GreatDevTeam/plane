...
export default {
  ...
  project_settings: {
    ...
    work_item_types: {
      ...
      description: "Define the types your work items can have and the custom fields each type carries.",
      add_type: "Add type",
      new_type: "New work item type",
      type_name: "Type name",
      type_name_is_required: "A name is required",
      type_description: "What this type is for",
      default_type: "Default",
      epic_type: "Epic",
      inactive: "Inactive",
      no_types: "No work item types yet",
      no_types_description: "Add a type to group your work items and give them fields of their own.",
      delete_type: "Remove type from project",
      delete_type_content:
        "The type is removed from this project. Work items already on it keep the values they were given.",
      fields: "Fields",
      add_field: "Add field",
      no_fields: "No fields on this type yet.",
      field_name: "Field name",
      field_name_is_required: "A name is required",
      field_key: "API key",
      field_key_hint: "How the field is named in the export, the API and the webhook payload.",
      field_description: "Description",
      field_type: "Field type",
      field_relates_to: "Relates to",
      required: "Required",
      ...
      type_is_immutable: "The type of a field cannot be changed once it is created.",
      delete_field: "Delete field",
      delete_field_content: "The field and every value work items hold for it are deleted. This cannot be undone.",
      options: "Options",
      add_option: "Add option",
      option_name: "Option name",
      no_options: "No options yet — add the choices this field offers.",
      set_as_default: "Set as default",
      default_option: "Default",
      delete_option: "Delete option",
      delete_option_content: "The option is deleted. Work items that hold it lose the value. This cannot be undone.",
      field_types: {
        TEXT: "Text",
        DECIMAL: "Number",
        OPTION: "Dropdown",
